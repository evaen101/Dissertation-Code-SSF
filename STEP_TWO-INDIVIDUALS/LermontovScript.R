...
#Export as csv files
write.csv(autumn15,'Lermontov_Autumn15.csv')
write.csv(winter1516,'Lermontov_Winter1516.csv')
write.csv(autumn16,'Lermontov_Spring16.csv')
