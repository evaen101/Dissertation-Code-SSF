...
spring14<-regular[regular$date<"2014-07-01",]
autumn15<-regular[regular$date>"2015-07-01",]
...
#Export as csv files
write.csv(spring14,'Smena_Spring14.csv')
write.csv(autumn15,'Smena_Autumn15.csv')
write.csv(autumn14,'Smena_Autumn14.csv')
write.csv(spring15,'Smena_Spring15.csv')
write.csv(winter1415,'Smena_Winter1415.csv')
