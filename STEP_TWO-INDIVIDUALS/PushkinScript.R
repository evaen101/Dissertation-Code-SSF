...
#Export as csv files
write.csv(autumn16,'Pushkin_Autumn16.csv')
write.csv(winter1617,'Pushkin_Winter1617.csv')
write.csv(spring17,'Pushkin_Spring17.csv')
write.csv(autumn17,'Pushkin_Autumn17.csv')
write.csv(winter1718,'Pushkin_Winter1718.csv')
write.csv(spring18,'Pushkin_Spring18.csv')
write.csv(autumn18,'Pushkin_Autumn18.csv')
write.csv(winter1819,'Pushkin_Winter1819.csv')
