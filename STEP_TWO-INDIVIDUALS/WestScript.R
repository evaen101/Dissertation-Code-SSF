...
#Export as csv files
write.csv(autumn14,'West_Autumn14.csv')
write.csv(winter1415,'West_Winter1415.csv')
write.csv(spring15,'West_Spring15.csv')
write.csv(autumn15,'West_Autumn15.csv')
write.csv(winter1516,'West_Winter1516.csv')
