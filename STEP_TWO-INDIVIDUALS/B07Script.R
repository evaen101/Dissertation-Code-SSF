...
#Export as csv files
write.csv(autumn15,'B07_Autumn15.csv')
write.csv(winter1516,'B07_Winter1516.csv')
write.csv(spring16,'B07_Spring16.csv')
write.csv(autumn16,'B07_Autumn16.csv')
write.csv(winter1617,'B07_Winter1617.csv')
write.csv(spring17,'B07_Spring17.csv')
write.csv(autumn17,'B07_Autumn17.csv')
write.csv(winter1718,'B07_Winter1718.csv')
write.csv(spring18,'B07_Spring18.csv')
write.csv(autumn18,'B07_Autumn18.csv')
write.csv(winter1819,'B07_Winter1819.csv')
