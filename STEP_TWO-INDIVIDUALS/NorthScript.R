...
#Export as csv files
write.csv(autumn14,'North_Autumn14.csv')
write.csv(winter1415,'North_Winter1415.csv')
write.csv(spring15,'North_Spring15.csv')
write.csv(autumn15,'North_Autumn15.csv')
write.csv(winter1516,'North_Winter1516.csv')
write.csv(spring16,'North_Spring16.csv')
write.csv(autumn16,'North_Autumn16.csv')
write.csv(winter1617,'North_Winter1617.csv')
write.csv(spring17,'North_Spring17.csv')
write.csv(autumn17,'North_Autumn17.csv')
write.csv(winter1718,'North_Winter1718.csv')
