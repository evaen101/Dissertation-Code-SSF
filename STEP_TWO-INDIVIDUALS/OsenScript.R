...
y1<-regular[regular$date<"2015-01-01",] #2014
y2<-regular[regular$date>="2015-01-01"&regular$date<"2016-01-01",] #2015
y3<-regular[regular$date>="2016-01-01"&regular$date<"2017-01-01",] #2016
y4<-regular[regular$date>="2017-01-01"&regular$date<"2018-01-01",] #2017
y5<-regular[regular$date>="2018-01-01"&regular$date<"2019-01-01",] #2018
y6<-regular[regular$date>="2019-01-01",] #2019
...
ggplot(y6,aes(x=date,y=speedKmD))+geom_line()

winter14<-regular[regular$date<"2014-04-27",]
spring14<-regular[regular$date>="2014-04-27"&regular$date<"2014-07-01",]
...
#Export as csv files
write.csv(winter14,'Osen_Winter14.csv')
write.csv(spring14,'Osen_Spring14.csv')
write.csv(autumn14,'Osen_Autumn14.csv')
write.csv(winter1415,'Osen_Winter1415.csv')
write.csv(spring15,'Osen_Spring15.csv')
write.csv(autumn15,'Osen_Autumn15.csv')
write.csv(winter1516,'Osen_Winter1516.csv')
write.csv(spring16,'Osen_Spring16.csv')
write.csv(autumn16,'Osen_Autumn16.csv')
write.csv(winter1617,'Osen_Winter1617.csv')
write.csv(spring17,'Osen_Spring17.csv')
write.csv(autumn17,'Osen_Autumn17.csv')
write.csv(winter1718,'Osen_Winter1718.csv')
write.csv(spring18,'Osen_Spring18.csv')
write.csv(autumn18,'Osen_Autumn18.csv')
write.csv(winter1819,'Osen_Winter1819.csv')
write.csv(spring19,'Osen_Spring19.csv')
